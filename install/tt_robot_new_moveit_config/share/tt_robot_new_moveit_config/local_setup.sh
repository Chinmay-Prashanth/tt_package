...
: ${AMENT_CURRENT_PREFIX:="/home/upsurge/tt_package/install/tt_robot_new_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tt_robot_new_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tt_robot_new_moveit_config/environment/path.sh"
