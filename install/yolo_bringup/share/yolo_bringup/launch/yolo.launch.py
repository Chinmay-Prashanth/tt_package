...
def generate_launch_description():
    ...
    def run_yolo(context: LaunchContext, use_tracking, use_3d):
        ...
        model_type_cmd = DeclareLaunchArgument(
            ...
            default_value="YOLO",
            choices=["YOLO", "World"],
            description="Model type from Ultralytics (YOLO, World)",
        )
        ...
        # Determine remapping topics based on tracking and 3D settings
            ...
            parameters=[
                {
                    ...
                    "classes": [32]  # Only detect sports ball (COCO index)
                }
            ],
